	...
	return (
		...
		<nav className='px-2 sm:px-4 py-2.5 rounded bg-red-800'>
			<div className='container flex flex-wrap items-center justify-between mx-auto'>
				...
				/>
				<div>
				<button type="button" onClick={handleLogOut} className="text-gray-900  hover:text-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:text-gray-700 mr-2 mb-2">
							<svg
